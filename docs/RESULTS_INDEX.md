...
| 投稿前资产缺口清单 | `docs/PAPER_ASSET_GAP_CHECKLIST.md` | `docs/PAPER_ASSET_GAP_CHECKLIST.md` | 固定 Figure 1 导出件、Table 2/3 paper artifacts 和图表美化状态 |
| Figure 1 系统图源和导出 | `docs/figures/figure1_system_flow.mmd` | `docs/figures/figure1_system_flow.mmd`, `results/paper/figure1_system_flow.svg`, `results/paper/figure1_system_flow.pdf` | 固定 system mismatch 和 deployable feedback pipeline 的 Mermaid 源与当前 SVG/PDF 导出 |
